    ...
    return (
        ...
        <div className="our_designs_container">
          <div className="clothes_types_container">
            ...
            <NavLink to="/app/magazine/jumpsuits" className="design_button" style={{textDecoration: 'none', color: '#fcf4f1'}}>Jumpsuits</NavLink>
          </div> 
          <div className="clothes_types_container">
            <div className="pants_box">
              <img src={Pants} alt="Pants" />
            </div>
            <NavLink to="/app/magazine/pants" className="design_button" style={{textDecoration: 'none', color: '#fcf4f1'}}>Pants</NavLink>
          </div>
          <div className="clothes_types_container">
            <div className="skirts_box">
              <img src={Skirts} alt="Skirts" />
            </div>
            <NavLink to="/app/magazine/skirts" className="design_button" style={{textDecoration: 'none', color: '#fcf4f1'}}>Skirts</NavLink>
          </div>
          <div className="clothes_types_container">
            <div className="dresses_box">
              <img src={Dresses} alt="Dresses" />
            </div>
            <NavLink to="/app/magazine/dresses" className="design_button" style={{textDecoration: 'none', color: '#fcf4f1'}}>Dresses</NavLink>
          </div>
          <div className="clothes_types_container">
            <div className="blouses_box">
              <img src={Blouses} alt="Blouses" />
            </div>
            <NavLink to="/app/magazine/blouses" className="design_button" style={{textDecoration: 'none', color: '#fcf4f1'}}>Blouses</NavLink>
          </div>
          <div className="clothes_types_container">
            <div className="short_box">
              <img src={Shorts} alt="Shorts" />
            </div>
            <NavLink to="/app/magazine/shorts" className="design_button" style={{textDecoration: 'none', color: '#fcf4f1'}}>Shorts</NavLink>
          </div>
